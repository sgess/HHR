...
The $\pi$-mode instability is a coupling that can occur between the two electron bunches in the ring. A single bunch executes a synchrotron oscillation around the fundamental frequency of the RF cavities as it circles the ring. A second bunch will also execute a synchrotron oscillation
